...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setFamily(data.data.family || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setFamily(data.family || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.chats_user = await users.getChats_user({
      transaction,
    });

    output.dashboards_user = await users.getDashboards_user({
      transaction,
    });
    ...
    output.screen_time_analyses_user = await users.getScreen_time_analyses_user(
      {
        transaction,
      },
    );
    ...
    output.family = await users.getFamily({
      transaction,
    });
