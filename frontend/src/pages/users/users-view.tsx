      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            ...
            <p>{users?.family?.name ?? 'No data'}</p>
          </div>

          <>
            <p className={'block font-bold mb-2'}>Chats User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.chats_user &&
                      Array.isArray(users.chats_user) &&
                      users.chats_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                ...
                <table>
                  ...
                  <tbody>
                    {users.dashboards_user &&
                      Array.isArray(users.dashboards_user) &&
          ...
          <>
            <p className={'block font-bold mb-2'}>Screen_time_analyses User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.screen_time_analyses_user &&
                      Array.isArray(users.screen_time_analyses_user) &&
                      users.screen_time_analyses_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.screen_time_analyses_user?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
