...
import { create } from '../../stores/families/familiesSlice';
...
FamiliesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_FAMILIES'}>
      {page}
    </LayoutAuthenticated>
  );
};
