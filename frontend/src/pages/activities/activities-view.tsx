    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Suggestions</p>
            <CardBox
                ...
                <table>
                  ...
                  <tbody>
                    {activities.suggestions &&
                      Array.isArray(activities.suggestions) &&
                      activities.suggestions.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
          ...
          <div className={'mb-4'}>
            ...
            <p>{activities?.family?.name ?? 'No data'}</p>
          </div>
