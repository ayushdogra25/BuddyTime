...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/family/familySlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureFamilyCols';
...
const TableSampleFamily = ({
  ...
  useEffect(() => {
    if (familyNotify.showNotification) {
      notify(familyNotify.typeNotification, familyNotify.textNotification);
    }
  }, [familyNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/family/family-view/?id=${id}`);
  };
...
export default TableSampleFamily;
