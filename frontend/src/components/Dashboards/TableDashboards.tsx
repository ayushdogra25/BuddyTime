...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/dashboards/dashboardsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureDashboardsCols';
import _ from 'lodash';
import dataFormatter from '../../helpers/dataFormatter';
import { dataGridStyles } from '../../styles';

import CardDashboards from './CardDashboards';

const perPage = 10;

const TableSampleDashboards = ({
  filterItems,
  setFilterItems,
  filters,
  showGrid,
  ...
  useEffect(() => {
    if (dashboardsNotify.showNotification) {
      notify(
        dashboardsNotify.typeNotification,
        dashboardsNotify.textNotification,
      );
    }
  }, [dashboardsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/dashboards/dashboards-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {dashboards && Array.isArray(dashboards) && !showGrid && (
        <CardDashboards
...
export default TableSampleDashboards;
