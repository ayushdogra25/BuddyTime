...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/families/familiesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureFamiliesCols';
...
const TableSampleFamilies = ({
  ...
  useEffect(() => {
    if (familiesNotify.showNotification) {
      notify(familiesNotify.typeNotification, familiesNotify.textNotification);
    }
  }, [familiesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/families/families-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {families && Array.isArray(families) && !showGrid && (
        <ListFamilies
          families={families}
          loading={loading}
...
export default TableSampleFamilies;
