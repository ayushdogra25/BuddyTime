...
const ListFamilies = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_FAMILIES');
            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/families/families-edit/?id=${item.id}`}
                  pathView={`/families/families-view/?id=${item.id}`}
