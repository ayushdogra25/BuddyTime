...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/chats/chatsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureChatsCols';
...
const TableSampleChats = ({
  ...
  useEffect(() => {
    if (chatsNotify.showNotification) {
      notify(chatsNotify.typeNotification, chatsNotify.textNotification);
    }
  ...
  const handleViewAction = (id: string) => {
    router.push(`/chats/chats-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {chats && Array.isArray(chats) && !showGrid && (
        <ListChats
          chats={chats}
          loading={loading}
...
export default TableSampleChats;
